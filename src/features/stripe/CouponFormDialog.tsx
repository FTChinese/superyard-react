...
import { StripeCoupon, StripePrice, stripePriceFormat } from '../../data/stripe-price';
...
export function CouponFormDialog(
  ...
  const handleSubmit = (values: CouponFormVal, helpers: FormikHelpers<CouponFormVal>) => {
